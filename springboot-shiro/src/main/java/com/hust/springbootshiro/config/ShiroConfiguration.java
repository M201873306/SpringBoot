package com.hust.springbootshiro.config;
...
//    }
    ...
    public DefaultWebSecurityManager getDefaultWebSecurityManager(AuthRealm authRealm1) {
        DefaultWebSecurityManager defaultWebSecurityManager = new DefaultWebSecurityManager();
        defaultWebSecurityManager.setRealm(authRealm1);
